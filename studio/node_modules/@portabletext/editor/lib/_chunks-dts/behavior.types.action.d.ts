...
declare class PortableTextEditor extends Component<PortableTextEditorProps<InternalEditor | undefined>> {
  ...
  static findByPath: (editor: PortableTextEditor, path: Path) => [_sanity_types7.PortableTextSpan | PortableTextObject | _sanity_types7.PortableTextTextBlock<_sanity_types7.PortableTextSpan | PortableTextObject> | undefined, Path | undefined];
  /**
   * @deprecated
   * Use `editor.send(...)` instead
   *
